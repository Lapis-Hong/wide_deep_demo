...
parser.add_argument(
    '--is_distribution', type=int, default=1,
    help='Distribution or net.')
...
def main(_):
    if FLAGS.is_distribution:
        ...
        #    "ps": ['10.172.110.162:4444'], 
        #    "worker": ['10.120.180.212:4444', '10.120.180.213:4444']})
        tf_config = {
            "cluster": {
                'ps': ['10.172.110.162:4444'],
                'chief': ['10.120.180.212:4444'],
                'worker': ['10.120.180.213:4444']
            }
        }
